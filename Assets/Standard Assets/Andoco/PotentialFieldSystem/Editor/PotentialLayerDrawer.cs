...
{
    [CustomPropertyDrawer(typeof(PotentialLayer))]
    public class PotentialLayerDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            PotentialFieldEditorHelper.LayerPopup(valuePos, property, data);
